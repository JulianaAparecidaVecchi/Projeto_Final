...
def janela_login():
    ...
    #Login
    input1 = ctk.CTkEntry(master=frame_login, placeholder_text='Nome de usuário', width=300,height=50, font=("Arial", 25))
    input1.grid(column=1, row=2, padx=20, pady=20)

    #senha
    input2 = ctk.CTkEntry(master=frame_login, placeholder_text='Senha', width=300,height=50, font=("Arial", 15), show="*")
    input2.grid(column=1, row=3, padx=20, pady=20)

    #botao de logar
    botao_logar = ctk.CTkButton(master=frame_login, text='LOGIN', width=300,height=50, fg_color=cor_botao, hover_color=cor_botao_hover,font=("Arial", 15))
    botao_logar.grid(column=1, row=4, padx=20, pady=20)

    #parte de cadastro
    label_cadastro = ctk.CTkLabel(master=frame_login, text='Caso não tenha cadastro:', font=('Arial',25))
...
def login_cadastrar():
    ...
    #Cria titulo 
    label_cadastro = ctk.CTkLabel(master=frame_cadastro, text='CADASTRAR-SE AQUI', font=("Arial", 20, "bold"))
    ...
    input1 = ctk.CTkEntry(master=frame_cadastro, placeholder_text='Nome de usuário', width=300,height=50, font=("Arial", 25))
    ...
    input2 = ctk.CTkEntry(master=frame_cadastro, placeholder_text='Senha', width=300,height=50, font=("Arial", 25), show="*")
    input2.grid(column=1, row=5, padx=20)

    #Botão Realiza cadastro
    botao_cadastro = ctk.CTkButton(master=frame_cadastro, text='CADASTRAR-SE', font=('Arial',25), width=300, fg_color=cor_botao, hover_color=cor_botao_hover , command=login_cadastrar)
    botao_cadastro.grid(column=1, row=6, padx=20, pady=40)
    #Botão voltar
    botao_voltar = ctk.CTkButton(master=frame_cadastro, text='VOLTAR', font=('Arial',25), width=150,height=50, fg_color=cor_botao, hover_color=cor_botao_hover , command=voltar_login)
